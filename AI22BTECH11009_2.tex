...
\\(ii)The probability of an event that cannot happen is \underline{0}.Such an event is called \underline{impossible event}.
\\(iii)The probability of an event that is certain to happen is \underline{1}.Such an event is called \underline{certain event}.
